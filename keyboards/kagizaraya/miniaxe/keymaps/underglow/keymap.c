...
[_ADJUST] =  LAYOUT(
  ...
  KC_F11,  KC_F12,  UG_PREV, UG_SATU, UG_SATD,      UG_VALU, UG_VALD, _______, _______, _______,
  QK_BOOT, UG_TOGG, UG_NEXT, UG_HUEU, UG_HUED,      KC_MPRV, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY,
                    _______, _______, _______,      _______,  _______, _______
)
};
